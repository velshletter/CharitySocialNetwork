...
public class NewsAdapterTest extends ArrayAdapter<NewsModelResponse> {
    private LayoutInflater inflater;
    private List<NewsModelResponse> listItemAd = new ArrayList<>();
    private Context context;

    public NewsAdapterTest(@NonNull Context context, int resource, List<NewsModelResponse> listItemAd, LayoutInflater inflater) {
